        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('admin.blogs.store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                            ...
                            <div class="md:col-span-8">
                                ...
                                <div class="mb-4">
                                     ...
                                     <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="excerpt" id="excerpt" rows="3">{{ old('excerpt') }}</textarea>
                                </div>

                                <div class="mb-4">
                                     <label for="content" class="block text-gray-700 text-sm font-bold mb-2">Content: </label>
                                     <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="content" id="content" rows="15">{{ old('content') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="md:col-span-4">
                                ...
                                <div class="p-4 bg-gray-50 rounded-lg shadow-sm mb-4">
                                    ...
                                    <div class="flex flex-col space-y-2">
                                         <div class="flex items-center mb-1">
                                            <input type="checkbox" name="is_published" id="is_published" class="form-checkbox h-5 w-5 text-blue-600" {{ old('is_published') ? 'checked' : '' }}>
                                            <label for="is_published" class="ml-2 text-gray-700">Is Published</label>
                                        </div>
                                        <div class="flex items-center mb-1">
                                            <input type="checkbox" name="status" id="status" class="form-checkbox h-5 w-5 text-green-600" {{ old('status', true) ? 'checked' : '' }}>
                                            <label for="status" class="ml-2 text-gray-700">Active Status</label>
                                        </div>
                                        <div class="flex items-center mb-2">
                                            <input type="checkbox" name="featured_homepage" id="featured_homepage" class="form-checkbox h-5 w-5 text-yellow-600" {{ old('featured_homepage') ? 'checked' : '' }}>
                                ...
                                <div class="p-4 bg-gray-50 rounded-lg shadow-sm mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="tags[]" id="tags" multiple class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-full">
                                            @foreach($tags as $tag)
    ...
    <script>
        ...
        function imagePreview() {
            return {
                uploadType: 'file',
                imageUrl: null,
                urlInput: '{{ old('featured_image_url') }}',
